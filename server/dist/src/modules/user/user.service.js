...
const redise_service_1 = require("../../../redis/redise.service");
let UserService = class UserService {
    prisma;
    fs;
    redis;
    constructor(prisma, fs, redis) {
        this.prisma = prisma;
        this.fs = fs;
        this.redis = redis;
    }
...
exports.UserService = UserService = __decorate([
    ...
    __metadata("design:paramtypes", [prisma_1.PrismaService, fs_helper_1.FsHelper, redise_service_1.RedisService])
], UserService);
